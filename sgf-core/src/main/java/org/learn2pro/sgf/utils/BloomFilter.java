...
package org.learn2pro.sgf.utils;

import java.nio.charset.Charset;
import java.util.Arrays;

/**
 * copy from https://github.com/apache/orc
 * <p>
...
public class BloomFilter {
    ...
    public void addBytes(byte[] val, int offset, int length) {
        ...
        // in the above paper
        long hash64 = val == null ? MurmurHash3.NULL_HASHCODE :
                MurmurHash3.hash64(val, offset, length);
        addHash(hash64);
    }
